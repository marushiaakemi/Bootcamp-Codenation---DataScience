...
normal = tuple(dataframe.normal.quantile([0.25,0.5,0.75]))
binomial = tuple(dataframe.binomial.quantile([0.25,0.5,0.75]))

res = (round(normal[0] - binomial[0],3), round(normal[1] - binomial[1],3), round(normal[2] - binomial[2],3))
res
...
def q3():
    diferenca = (round(dataframe.binomial.mean() - dataframe.normal.mean(),3), round(dataframe.binomial.var() - dataframe.normal.var(),3))
    return diferenca
