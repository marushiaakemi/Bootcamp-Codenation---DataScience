...
def q1():
    altura = get_sample(athletes, 'height', 3000, 42)

    return sct.shapiro(altura)[1] > 0.5
...
def q2():
    altura = get_sample(athletes, 'height', 3000, 42)
    return bool(sct.jarque_bera(altura)[1] > 0.5)
...
def q3():
    altura = get_sample(athletes, 'height', 3000, 42)
    return bool(sct.normaltest(altura).pvalue > 0.5)
